...
/**
 * The controller which controls the manage tables pane
 *
 * @author Brett Downey
 */
public class ManageTablesPane implements Initializable, Controller {

  @Override
  public void initialize(URL location, ResourceBundle resources) {
    ControllerMap.addController(ControllerType.MANAGE_TABLES_PANE_CONTROLLER, this);
  }

  @Override
  public ControllerType getType() {
    return ControllerType.MANAGE_TABLES_PANE_CONTROLLER;
  }
}
