...
import main.java.lucia.client.protocol.message.impl.order.SetCurrentOrdernumMessage;
import main.java.lucia.net.packet.PacketProcessor;
import main.java.lucia.net.protocol.ProtocolBuilder;

public class SetCurrentOrdernumHandler extends MessageHandler {
    /**
     ...
     */
    @Override
    public SetCurrentOrdernumMessage decodeInbound(PacketProcessor packetProcessor) {
        return new SetCurrentOrdernumMessage(packetProcessor);
    }
}
