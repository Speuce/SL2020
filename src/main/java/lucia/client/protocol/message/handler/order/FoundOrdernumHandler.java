...
public class FoundOrdernumHandler extends MessageHandler {
    /**
     ...
     */
    @Override
    public FoundOrdernumMessage decodeInbound(PacketProcessor packetProcessor) {
        return new FoundOrdernumMessage(packetProcessor);
    }
}
