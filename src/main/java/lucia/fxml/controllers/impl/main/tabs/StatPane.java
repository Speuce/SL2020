...
/**
 * The controller which controls the statistics page
 *
 * @author Brett Downey
 */
public class StatPane implements Initializable, Controller {

  @Override
  public void initialize(URL location, ResourceBundle resources) {
    ControllerMap.addController(ControllerType.STAT_PANE_CONTROLLER, this);
  }

  @Override
  public ControllerType getType() {
    return ControllerType.STAT_PANE_CONTROLLER;
  }
}
