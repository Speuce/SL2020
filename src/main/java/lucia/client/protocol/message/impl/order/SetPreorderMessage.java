...
/**
 * Sent from the server to the client when a preorder should be set/added
 */
public class SetPreorderMessage extends MattMessage {
    /**
     * The constructor for a {@link Message} which provides the needed {@link PacketProcessor}.
     *
     * @param packetProcessor
     */
    public SetPreorderMessage(PacketProcessor packetProcessor) {
