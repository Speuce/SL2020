...
public class DispatchPane implements Controller {
  ...
  public void load() {
    ArrayList<Order> driverOrders = OrderManager.INSTANCE.getPendingOrdersDelivery();
    ArrayList<Order> pickupOrders = OrderManager.INSTANCE.getPendingOrders();
    ArrayList<Order> ordersMade = OrderManager.INSTANCE.getPendingOrdersMade();
